          ...
          Obx(() {
            return Column(
              children: [
                ...
                //   height: 20,
                // ),
                // repliesController.postReplies.isEmpty ?
                ...
                Expanded(
                  child: SingleChildScrollView(
                    child: Column(
                      children: items.map((e) => ReplyListItem(reply: e)).toList(),
                    ),
                  ),
                ),
                      ...
                      Expanded(
                          ...
                          ClipRRect(
                            ...
                            child: CachedNetworkImage(
                              imageUrl: profileController.currentProfilePic
                                  .value,
                              width: 46,
                              fit: BoxFit.cover,
                              height: 46,),
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            ProfilePicture(
                name: reply.name, radius: 15, fontsize: 12),
